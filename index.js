...
function validateUser(user) {
  try {
    ...
    return { error: error.message, cause: user };
  }
...
function evaluateExpression(expression) {
  try {
    if (!expression) {
      throw new EvalError("Аргумент має бути математичним виразом !");
    } else {
      // Виконуємо функцію eval у блоку try, і в разі помилки перехоплюємо її.
      return eval(expression);
    }
  } catch (error) {
    // Обробляємо помилку, якщо вона виникає при виконанні eval.
